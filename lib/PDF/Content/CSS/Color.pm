...
class PDF::Content::CSS::Color {
    ...
    use MONKEY-TYPING;
    augment class Array {
        method PDF::Content::CSS::Color() returns PDF::Content::CSS::Color {
            +self == 1
            ?? PDF::Content::CSS::Color( self[0] )
            !! PDF::Content::CSS::Color.new( :rgb(self) );
        }
    }
    augment class Str {
        ...
        method PDF::Content::CSS::Color() returns PDF::Content::CSS::Color {
            ...
            PDF::Content::CSS::Color.new( :rgb($rgb.list), :$alpha );
        }
    }
}
