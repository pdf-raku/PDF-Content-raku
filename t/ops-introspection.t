...
is-json-equiv $g.gsave, [], 'gsave initial';
is-json-equiv $g.graphics-state, %gs-initial;
is-deeply $g.context, GraphicsContext::Page;

$g.Save;

is-json-equiv $g.gsave, (%gs-initial,), 'gsave saved';
is-json-equiv $g.gsave(:delta), (%(), ), 'gsave saved :delta';
...
is-json-equiv $g.gsave(:delta), [ {:CTM[115, 12, 180, 19, 93, 15], :Font[{}, 16]}, ], 'gsave saved :delta';
...
is-json-equiv $g.gsave, [], 'gsave final';
