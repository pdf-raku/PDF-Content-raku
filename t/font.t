...
my $hb-afm = PDF::Basic::Util::Font::core-font( 'Helvetica-Bold' );
...
my $ab-afm = PDF::Basic::Util::Font::core-font( 'Arial-Bold' );
isa-ok $hb-afm, ::('Font::AFM'); 
is $hb-afm.FontName, 'Helvetica-Bold', 'FontName';
...
my $hb-afm-again = PDF::Basic::Util::Font::core-font( 'Helvetica-Bold' );

ok $hb-afm-again === $hb-afm, 'font caching';

my $tr-afm = PDF::Basic::Util::Font::core-font( 'Times-Roman' );
...
for (win => "Á®ÆØ",
     mac => "ç¨®¯") {
    my ($enc, $expected) = .kv;
    my $fnt = PDF::Basic::Util::Font::core-font( 'helvetica', :$enc );
