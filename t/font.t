...
my $hb-afm = PDF::Graphics::Font::core-font( 'Helvetica-Bold' );
...
my $ab-afm = PDF::Graphics::Font::core-font( 'Arial-Bold' );
isa-ok $hb-afm, ::('Font::AFM'); 
is $hb-afm.FontName, 'Helvetica-Bold', 'FontName';
...
my $hb-afm-again = PDF::Graphics::Font::core-font( 'Helvetica-Bold' );

ok $hb-afm-again === $hb-afm, 'font caching';

my $tr-afm = PDF::Graphics::Font::core-font( 'Times-Roman' );
...
for (win => "Á®ÆØ",
     mac => "ç¨®¯") {
    my ($enc, $expected) = .kv;
    my $fnt = PDF::Graphics::Font::core-font( 'helvetica', :$enc );
